    ...
    <div class="container">
        ...
        <?php if ($articles): ?>
            <div class="article-list">
                ...
                <select id="article-select" class="article-selector">
                    <?php foreach ($articles as $article): ?>
                        <option value="<?= htmlspecialchars($article['url']) ?>">
        ...
        <form method="post">
            <input type="url" name="url" placeholder="Plak hier de artikel-URL…" required>
            <button type="submit">Lees</button>
        </form>
